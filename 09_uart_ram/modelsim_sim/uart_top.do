...
add wave -noupdate -label bps_clk_up_16x -radix binary /uart_top_tb/top_duf/bps_clk_up_16x
add wave -noupdate -label cnt_16x -radix unsigned /uart_top_tb/top_duf/top_rx/cnt_16x
add wave -noupdate -label cnt_16x_f -radix binary /uart_top_tb/top_duf/top_rx/cnt_16x_f
...
add wave -noupdate -label rxd_d1 -radix binary /uart_top_tb/top_duf/top_rx/rxd_d1
...
add wave -noupdate -label tx_st2 -radix binary /uart_top_tb/top_duf/top_tx/tx_st2
